...
const activeLink = () => {
  ...
  navLinks.forEach((item) => {
    ...
    if (item.href.includes(currentActive)) {
...
sr.reveal(`.about__item__content-2, .about__item__image-1`, {
  origin: "left",
});
sr.reveal(`.about__item__content-1, .about__item__image-2`, {
  origin: "right",
});
